...
const node_fetch_1 = __importDefault(__webpack_require__(3));
function activate(context) {
    let currentPanel = undefined;
    let cohereApiKey = undefined;
    const initializeCohere = () => {
        try {
            cohereApiKey = vscode.workspace.getConfiguration('aiCodeAssistant').get('cohereApiKey');
    ...
    const createWebviewPanel = () => {
        try {
            currentPanel = vscode.window.createWebviewPanel('aiCodeAssistant', 'AI Code Assistant', vscode.ViewColumn.Two, {
                enableScripts: true,
    ...
    const handleChatMessage = async (message) => {
        ...
        try {
            ...
            const response = await (0, node_fetch_1.default)('https://api.cohere.ai/v1/chat', {
                method: 'POST',
                headers: {
    ...
    const handleFileContent = async (message) => {
        if (!currentPanel) {
